...
public class STAMProbability {
    ...
    STAMProbability(double[] Ext, Array2d Varxt, double N, double theta)  {
        this.N = N;
        this.Ext = Ext;
        this.Varxt = Varxt;
    ...
    public double prob_spike0(double alpha, double beta){
    ...
    public double prob_spike1(double alpha, double beta){
        if (alpha > Math.pow(10, 3) && beta > Math.pow(10, 3)) {
            return 0;
        }
