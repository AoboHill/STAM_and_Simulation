...
public class STAMTreeLikelihoodVA extends TreeLikelihood{
    ...
    public STAMTreeLikelihoodVA() throws Exception {
...
//	    			dprint /*= false*/);
    ...
    protected int traverse(final Node node) throws MathException {
    ...
    public double[] rateToTransition(double[][] Bins, double time, double[] matrix_, int N,double theta,double[][]CL_points) throws MathException {
...
//                System.out.println(mom_.Varxt);
                STAMProbabilityVA prob = new STAMProbabilityVA(mom_.Ext, mom_.Varxt,N,theta);
